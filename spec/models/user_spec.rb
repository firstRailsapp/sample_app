...
describe User do
  ...
  describe "micropost associations" do
    ...
    describe "status feed" do
      ...
      it "should not have a other user's microposts" do
  ...
  describe "relationships" do
    ...
    it "should have a  unfollow! method" do
     # @following.should respond_to(:unfollow!)
    end
    ...
    it "should have a reverse _relationships method" do
    ...
    it "should   include the follower in followers array" do
